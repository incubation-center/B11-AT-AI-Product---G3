    ...
    <section className="mt-6 rounded-2xl border border-[hsl(var(--line))] bg-[hsl(var(--surface))] p-6 shadow-sm">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-semibold text-[hsl(var(--ink))]">Uploaded Documents</h2>
            <p className="text-xs text-[hsl(var(--muted-ink))]">Search, filter, and order by due date.</p>
          </div>
        </div>
        <span className="rounded-full border border-[hsl(var(--line))] px-3 py-1 text-xs font-medium text-[hsl(var(--primary))]">
